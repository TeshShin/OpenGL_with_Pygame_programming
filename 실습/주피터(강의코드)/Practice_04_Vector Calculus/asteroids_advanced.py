...
#black_hole2.x, black_hole2.y = 7, -7
...
def gravitational_field(sources, x, y):
    fields = [vectors.scale(source.gravity, (source.x - x, source.y - y))
...
thrust = 2
trajectory_mode = True # 기본 False /실험 -> 쉽의 초기 속도를 넣고 True/ 궤적을 보여주는 모드임 ㅇㅇ
